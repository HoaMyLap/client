...
export default function TermsPage() {
  return (
    <div className="min-h-screen w-full bg-background text-foreground relative overflow-x-hidden font-sans pb-20">
      ...
      {/* Document content */}
      <main className="max-w-4xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10 relative z-10 mt-10">
        ...
        {/* Text Area */}
        <article className="md:col-span-3 space-y-12 text-secondary text-sm leading-relaxed">
          {/* Section 1 */}
          <section id="dieu-khoan" className="space-y-4 scroll-mt-24">
            <h2 className="text-lg font-bold text-heading font-display flex items-center gap-2">
      ...
      {/* Footer CTA */}
      <section className="max-w-4xl mx-auto px-6 py-16 text-center relative z-10 border-t border-border mt-20">
